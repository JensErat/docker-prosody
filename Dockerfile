...
RUN apt-key adv --keyserver pool.sks-keyservers.net --recv-keys 107D65A0A148C237FDF00AB47393D7E674D9DBB5 && \
    ...
    apt-get update && \
    DEBIAN_FRONTEND=noninteractive apt-get install -y prosody=${PROSODY_VERSION} lua-sec lua-event lua-zlib lua-ldap lua-dbi-mysql lua-dbi-postgresql lua-dbi-sqlite3 && \
